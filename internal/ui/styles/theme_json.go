...
/*
"""
data: OpenCode 格式主题 JSON 二进制切片
核心流程:
1. 反序列化 JSON 到 opencodeTheme 结构体
2. 校验 dark.palette 中的 neutral 基础底色字段
3. 对缺失的 accent/info 字段回退到 primary 颜色
4. 基于调色板构建 quickStyleOpts 并在内存中衍生色阶
5. 调用 quickStyle 生成 Crush 兼容的 Styles
"""
*/
